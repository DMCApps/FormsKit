...
private func makeForm(rows: [AnyFormRow], persistence: (any FormPersistence)? = nil) -> FormDefinition {
    FormDefinition(id: "test-form", title: "Test", rows: rows, persistence: persistence)
}
...
struct FormViewModelTests {
    ...
    func defaultValuesLoaded() {
        let form = makeForm(rows: [
            AnyFormRow(BooleanSwitchRow(id: "toggle", title: "T", defaultIsOn: true)),
            AnyFormRow(TextInputRow(id: "name", title: "N", defaultText: "Alice"))
        ])
    ...
    func typedValueSetters() {
        let form = makeForm(rows: [
            ...
            AnyFormRow(NumberInputRow(id: "dbl", title: "Dbl", defaultDouble: nil)),
    ...
    func validateAllSkipsHiddenRows() {
        ...
        let form = makeForm(rows: [
            AnyFormRow(BooleanSwitchRow(id: "show", title: "Show", defaultIsOn: false)),
    ...
    func resetRestoresDefaults() {
        let form = makeForm(rows: [
            AnyFormRow(BooleanSwitchRow(id: "t", title: "T", defaultIsOn: true))
        ])
        let vm = FormViewModel(formDefinition: form)
